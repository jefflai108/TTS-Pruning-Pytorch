...
./tts-prune_progressive.sh \
    ...
    --train_args "--init_param exp/ljspeech_tts_train_transformer_raw_phn_tacotron_g2p_en_no_space/tts_pretrained-valid.loss.best-prune_at_0.9/valid.loss.best.pth" \
    ${opts} "$@"
