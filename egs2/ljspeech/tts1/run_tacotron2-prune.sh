...
./tts-prune.sh \
    ...
    --train_args "--init_param exp/ljspeech_tts_train_tacotron2_raw_phn_tacotron_g2p_en_no_space/tts_train_raw_phn_tacotron_g2p_en_no_space/valid.loss.best.pth" \
    ${opts} "$@"
