...
./tts_teacher-prune.sh \
    ...
    --train_args "--init_param exp/ljspeech_tts_train_transformer_raw_phn_tacotron_g2p_en_no_space/tts_train_transformer_raw_phn_tacotron_g2p_en_no_space/valid.loss.best.pth" \
    ${opts} "$@"
