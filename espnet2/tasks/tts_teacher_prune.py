...
#from espnet2.tasks.abs_task_prune import AbsTask
from espnet2.tasks.abs_task_teacher_prune import AbsTask
from espnet2.train.class_choices import ClassChoices
from espnet2.train.collate_fn import CommonCollateFn
from espnet2.train.preprocessor import CommonPreprocessor
#from espnet2.train.trainer import Trainer
#from espnet2.train.trainer_prune import Trainer
from espnet2.train.trainer_teacher_prune import Trainer
...
from espnet2.tts.transformer_teacher import Transformer
...
class TTSTask(AbsTask):
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetTTSModel:
        ...
        # 6. (extra) build teacher model  
        teacher_model = ESPnetTTSModel(
            feats_extract=feats_extract,
            pitch_extract=pitch_extract,
            energy_extract=energy_extract,
            normalize=normalize,
        ...
        assert check_return_type(teacher_model)
