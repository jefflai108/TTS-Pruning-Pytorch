...
class Transformer(AbsTTS):
    ...
    def forward(
        ...
        #loss, stats, weight, olens, after_outs, before_outs, logits, att_ws = force_gatherable((loss, stats, batch_size, olens, after_outs, before_outs, logits, att_ws), loss.device)

        #return loss, stats, weight
        return loss, stats, batch_size, olens, after_outs, before_outs, logits, att_ws
